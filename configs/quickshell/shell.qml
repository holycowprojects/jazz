...
ShellRoot {
    ...
    Process {
        id: scanProc
        command: ["python3", "/home/holycowstudios/.local/share/jazz/scan-apps.py"]
    ...
    FileView {
        id: widgetPrefsFile
        path: "/home/holycowstudios/.local/share/jazz/widget-prefs.json"
        onLoaded: {
            try {
    ...
    PanelWindow {
        ...
        FileView {
            id: chatRequestFile
            path: "/home/holycowstudios/.local/share/jazz/chat-request.json"
            onSaved: chatProc.running = true
        }
        Process {
            id: chatProc
            command: ["curl", "-s", "-N", "-X", "POST", "http://localhost:11434/api/chat", "--data-binary", "@" + "/home/holycowstudios/.local/share/jazz/chat-request.json"]
            stdout: SplitParser {
                onRead: function (data) {
                    if (!data) return
                    try {
